...
import { ADD_BUTTON_LABAL, ADD_ITEM, BACK, DELETE_BUTTON_DELETE_MODAL, DELETE_BUTTON_LABAL, DELETE_CONFIRM, DELETE_CONFIRM_MESSEGE, ITEMS_API, ITEMS_PAGE_NAME, ITEMS_SEARCH_PLACEHOLDER, ITEMS_TABLE_FIELDS, NO_RECORDS_FOUND, SEARCH, UNIT_API, UNIT_CATEGORY_API, UNIT_CATEGORY_NAME_LABAL, UNIT_CATEGORY_TABLE_FIELDS, UPDATE, UPDATE_BUTTON_LABAL, UPDATE_ITEM_MODEL_TITLE } from '@/app/constants/constants';
...
const ItemsPage = () => {
  ...
  // Mark as intentionally used to satisfy lint without changing behavior
