...
const Invoice = React.forwardRef<HTMLDivElement, InvoiceProps>((props, ref) => (
  <div ref={ref} style={{ maxWidth: '600px', margin: 'auto', paddingTop: '30px' }}>
    <div className='text-center'>
      <div className='pt-2'></div>
      <h6 className='text-center'>{props.hardware_name}</h6>
      <a className='text-center text-decoration-none text-dark' style={{ fontSize: '11px' }}>
        📫 {props.hardware_address}
      </a><br />
      <a className='text-center text-decoration-none text-dark' style={{ fontSize: '11px' }}>
        📱 {props.hardware_phone}
      </a><br />
      <a className='text-center text-decoration-none text-dark' style={{ fontSize: '11px' }}>
