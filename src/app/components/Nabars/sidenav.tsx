...
import { 
  ...
  STOCKS_UI, SUPPLIER_UI, SUPPLIERS_PAGE_NAME, UNIT_CATEGORY_PAGE_NAME, UNIT_CATEGORY_UI,
  UNIT_CONVERSION_PAGE_NAME, UNIT_CONVERSION_UI, UNIT_PAGE_NAME, UNIT_UI, ACCOUNTS_UI, ACCOUNTS_PAGE_NAME,
  SIGN_OUT, SIGN_OUT_CONFIRMATION, BACK
...
const SideNav = () => {
  ...
  const renderNavItem = (href: string | undefined, Icon: IconType, label: string) => {
